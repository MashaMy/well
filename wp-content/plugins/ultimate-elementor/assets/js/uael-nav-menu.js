( function( $ ) {
	...
	function _sizeCal( id ){
		...
		$( '.elementor-element-' + id + ' li.menu-item' ).each( function() {
			...
			if ( 'column' == dropdown_width ){
				...
				var col_pos = $( '.elementor-element-' + id).closest('.elementor-column').offset().left - $this.offset().left;
				...
				var sec_pos = $( '.elementor-element-' + id).closest('.elementor-section').offset().left - $this.offset().left;

				$this.find('ul.sub-menu').css('width', width + 'px' );
				$this.find('ul.sub-menu').css('left', sec_pos + 'px' );
			}else if ( 'widget' == dropdown_width ){

				var width = $('.elementor-element-' + id + '.elementor-widget-uael-nav-menu').outerWidth();
				var widget_pos = $('.elementor-element-' + id + '.elementor-widget-uael-nav-menu').offset().left - $this.offset().left;

				$this.find('ul.sub-menu').css('width', width + 'px' );
				$this.find('ul.sub-menu').css('left', widget_pos + 'px' );
			}else if ('container' == dropdown_width) {

				var width = $( '.elementor-element-' + id).closest('.elementor-container').outerWidth();
				var cont_pos = $( '.elementor-element-' + id).closest('.elementor-container').offset().left - $this.offset().left;
	...
	function _toggleClick( id ){
		...
		$( '.elementor-element-' + id + ' .uael-nav-menu__toggle .uael-nav-menu-icon' ).off( 'click keyup' ).on( 'click keyup', function( event ) {
