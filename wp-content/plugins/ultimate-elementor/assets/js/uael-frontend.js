					...
					if( ! invalid_field && error_exists.length === 0 ) {
						...
						$.post( ajaxurl, {
							...
							if ( true === response.success ) {
								...
								_printErrorMessages( $scope, username, 'Unknown username. Check again or try your email address.' );
							} else if ( false === response.success && 'invalid_email' === response.data ) {
								_printErrorMessages( $scope, username, 'Unknown email address. Check again or try your username.' );
							}
