        ...
        <td>
            <fieldset>
                <legend class="screen-reader-text">
                    <span><?php _e("Remove Attachments", "smart-cleanup-tools"); ?></span></legend>
                <select class="widefat sct-dropdown-single" name="remove[comments][remove]">
                    ...
                    <option value="remove_unapproved"><?php _e("Remove unapproved comments", "smart-cleanup-tools"); ?></option>
