...
function seopress_schemas_maybe_render_blank_state($which)
{
	...
	if ('seopress_schemas' === $post_type && 'bottom' === $which) {
		...
		if(isset($_GET["seopress_support"]) && $_GET["seopress_support"] === "1"):
			?>
			<a href="<?php
				echo wp_nonce_url(
					add_query_arg(
...
For best results, provide multiple high-resolution images (minimum of 50K pixels when multiplying width and height) with the following aspect ratios: 16x9, 4x3, and 1x1.', 'wp-seopress-pro') .'</span>
	...
	echo '<p>
									...
									<p>
										...
										<span class="description">'.__('Type of employment, You can include more than one employmentType property. Authorized values: "FULL_TIME", "PART_TIME", "CONTRACTOR", "TEMPORARY", "INTERN", "VOLUNTEER", "PER_DIEM", "OTHER"','wp-seopress-pro').'</span>
									</p>
									<p>
