...
class DataTable extends EAE_Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $repeater->add_control(
			...
			[
				...
				'selectors' => [
                    ...
                    //'{{WRAPPER}} {{CURRENT_ITEM}} .eae-sort-icon ' => 'text-align: {{VALUE}}',
				],
                'condition' => [
					'header_row_column_type' => 'column'
				], 
        ...
        //         'size_units'    => [ 'px', 'em', '%' ],
        //         'selectors'     => [
        //             '{{WRAPPER}} .eae-table-container' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
        //         ]
        //     ]
        // );
        ...
        $this->add_responsive_control(
            ...
            [
               'label' => __('Bottom Spacing', 'wst-eae'),
               'type'  =>  Controls_Manager::SLIDER,
               'range' => [
                    'px' => [
                        'min' => 1,
    ...
    protected function render() {
        ...
        // if($settings['eae_table_responsive'] == 'yes'){
        //     $this->add_render_attribute('table-container', 'class', 'eae-responsive-table');
        // }
    ...
    function render_head_row($counter){ 
    ...
    function render_head_column($head_data, $index, $settings, $sortable ){
        //echo $sortable;
        ...
        $this->set_render_attribute($head_column_repeater_key,[
        ...
        <th <?php echo $this->get_render_attribute_string( $head_column_repeater_key );?>>
            <div <?php echo $this->get_render_attribute_string('main-wrap'); ?> >
                <div class="eae-table__head-column-wrapper">
                    ...
                    <?php if ( $head_data['head_column_icon_position'] == 'before' || $head_data['head_column_icon_position'] == 'top' ): 
                            $this->render_head_icon($head_data); 
                    endif;?>
                    
                    <?php if( !empty( $head_text ) ): ?>
                        <span class="eae-table__column-text"><?php echo $head_text; ?></span>
                    <?php endif; ?>

                    <?php if ( $head_data['head_column_icon_position'] == 'after' || $head_data['head_column_icon_position'] == 'bottom' ): 
                            $this->render_head_icon($head_data); 
                    endif;?>

                </div>
                <?php if($settings['eae_sortable'] === 'yes' && $sortable) : 
    ...
    function render_sort_icon($settings){
    ...
    function render_head_icon($head_data){
        ...
        if( !empty( $head_data['head_column_icon'] ) || !empty( $head_data['head_column_image']['url'] ) || !empty( $head_data['lottie_animation_url'] ) ) {
            ...
            ?>
                ...
                <span <?php echo $this->get_render_attribute_string('eae-icon') ?>>
                    ...
                    <?php } elseif($head_icon_type === 'image'){
                        ...
                        $this->set_render_attribute('head-animation', 
                            array(
    ...
    function render_column($data, $table_row){
        ...
        //$this->add_render_attribute( 'row_column_repeater_key', 'class', 'eae-table__body_row_column' );
        $id = $data['_id'];
        ...
        //echo'<pre>'; print_r( $data['body_column_link'] );
        ...
        <td <?php echo $this->get_render_attribute_string($row_column_repeater_key); ?>>
            <div class="eae-table__body-column-wrapper">
                <<?php echo $elem; ?> <?php echo $this->get_render_attribute_string('table_text'); ?>> 

                    <?php if( $data['body_text_type'] !='template' ): ?>   
                        <?php if ( $data['body_column_icon_position'] == 'before' || $data['body_column_icon_position'] == 'top' ): 
                    ...
                    <?php /* Render template */ if( $data['body_text_type'] == 'template' ):
                    ...
                    <?php if( $data['body_text_type'] !='template' ): ?> 
                        <?php if ( $data['body_column_icon_position'] == 'after' || $data['body_column_icon_position'] == 'bottom'): 
                            $this->render_icon($data); 
                        endif;
                    endif; ?>
        ...
        if( !empty( $data['body_column_icon'] ) || !empty( $data['body_column_image']['url'] ) || !empty( $data['lottie_animation_url'] ) ) {
            ...
            ?>      
                    <span <?php echo $this->get_render_attribute_string('eae-icons') ?>>
                        ...
                        <?php } elseif($body_icon_type === 'image') {
                            if( !empty( $data['body_column_image']['id'] ) || !empty( $data['body_column_image']['url'] )){ 
                                ...
                                $this->set_render_attribute('body-animation', 
                                    array(
