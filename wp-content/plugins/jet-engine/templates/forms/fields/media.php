...
<div class="jet-engine-file-upload">
	...
	<div class="jet-engine-file-upload__fields">
		<input class="jet-engine-file-upload__value" type="hidden" name="<?php echo $this->get_field_name( $args['name'] ); ?>" data-field-name="<?php echo $args['name']; ?>" value="<?php echo htmlspecialchars( json_encode( Jet_Engine_Forms_File_Upload::instance()->get_result_value( $args ) ) ); ?>" <?php echo $required; ?>>
